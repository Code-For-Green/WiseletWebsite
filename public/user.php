...
<head>
  ...
  xmlhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      $flow = myObj.reduce(function(previousValue, currentValue) {
        return previousValue + +currentValue.flow;
      }, 0);
      setData($flow);
    }
  };
  ...
  function setData(flow)
  {
    $waterLiter = flow;
    document.getElementById("wr-used").innerHTML = $waterLiter + "L";
    document.getElementById("wr-glass").innerHTML = $waterLiter*0.25;
    document.getElementById("wr-bottle").innerHTML = $waterLiter*0.70;
    document.getElementById("wr-money").innerHTML = Math.round($waterLiter*0.0012*100)/100 + "$";
  }
  </script>
</head>
